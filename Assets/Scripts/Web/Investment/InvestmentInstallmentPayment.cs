...
public class InvestmentInstallmentPayment
{
    ...
    public InvestmentInstallmentPayment(int id, int investmentPaymentId, int investmentInstallmentId, double amount, double discountAmount, 
                                        double newBalance, DateTime createDateTime, DateTime updateDateTime, int status)
    {
        Id = id;
