...
public class InvestmentFull
{
    ...
    public InvestmentFull(int investmentId, int projectId, int productTypeId, int appUserId, DateTime effectiveDate, 
                          int developmentTerm, int cpiCount, double totalAmount, double reserveAmount, double dueAmount,
                          double discountRate, double discountAmount,
                          double balance, DateTime? completionDate, String docuSignReference, int investmentMotiveId, String boardComment,
                          int investmentStatusId,
