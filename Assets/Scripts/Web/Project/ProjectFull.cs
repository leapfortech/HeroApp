...
public class ProjectFull
{
    ...
    public int CpiRemain => CpiTotal - CpiCount;
    ...
    {
        get { return null; }
        set { CoverSprite = value?.CreateSprite($"Cover{ProjectId:D02}"); }
    }
    public Sprite CoverSprite { get; set; } = null;
    ...
    public ProjectFull(int projectId, String projectType, String code, String name,
                      String description, String details, double totalArea, double totalBuiltArea,
                      int levelCount, String currency, String currencySymbol, double cpiValue, int cpiTotal, int cpiCount, double totalValue, DateTime startDate,
                      int developmentTerm, double rentalGrowthRate, double capitalGrowthRate, String earningPeriod, double managementCost,
