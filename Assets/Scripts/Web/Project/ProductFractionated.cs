...
public class ProductFractionated
{
    ...
    public ProductFractionated(int id, int projectId, int cpiMin, int cpiMax, int cpiDefault, double reserveRate,
                               int overdueMax, DateTime createDateTime, DateTime updateDateTime, int productFractionatedStatusId)
    {
        Id = id;
        ProjectId = projectId;
        CpiMin = cpiMin;
