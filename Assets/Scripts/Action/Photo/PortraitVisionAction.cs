...
{
    [Serializable]
    public class PortraitEvent : UnityEvent<Texture2D> { }
    ...
    [Space]
    [SerializeField]
    private PortraitEvent onPortraitTaken = null;
    ...
    private void ApplyPhoto(Texture2D photo)
    {
        ...
        if (imgPortrait != null)
            imgPortrait.Sprite = photo.CreateSprite("Portrait");

        onPortraitTaken.Invoke(photo);
    }
}
