...
public class PhraseAction : MonoBehaviour
{
    [Title("Element")]
    [SerializeField]
    ...
    public void NextGame()
    {
        ...
        puzzleService.GetNextPuzzle(new PuzzleNextRequest(StateManager.Instance.Player.Id, 3, difficulty));
    }
    ...
    public void StartPuzzle(int difficultyChanged)
    {
        ...
        PageManager.Instance.ChangePage(pagPhrase);
